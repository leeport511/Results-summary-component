...
function App() {
    return (
        <div className="container mx-auto h-screen xl:flex xl:items-center xl:justify-center">
            <div className="xl:flex xl:w-[50%] xl:items-center xl:justify-center xl:rounded-3xl xl:shadow-xl xl:shadow-light-lavender">
                <section className="items-center justify-center rounded-b-3xl bg-gradient-to-b from-light-slate-blue to-light-royal-blue p-4 text-center xl:flex xl:h-[100%] xl:w-[100%] xl:flex-col xl:rounded-3xl xl:p-10">
                ...
                <section className="p-6 xl:m-6 xl:w-[100%] xl:rounded-3xl">
